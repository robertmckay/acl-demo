...
@StartableByService
@StartableByRPC
class ACLCreateFlow(val initialParties : List<Party>) : FlowLogic<SignedTransaction>() {
...
@InitiatedBy(ACLCreateFlow::class)
class ACLCreateReceiver(val otherSession: FlowSession) : FlowLogic<Unit>() {
